...
try {
    // Vérifier que la réservation appartient à l'utilisateur et n'est pas déjà annulée
    $stmt = $pdo->prepare("
        SELECT r.*, t.nom_terrain, t.ville
        FROM Reservation r
    ...
    if (!$reservation) {
        $_SESSION['message'] = "Réservation introuvable ou vous n'avez pas les droits pour l'annuler.";
        $_SESSION['message_type'] = "error";
        header('Location: mes-reservations.php');
        exit();
    }
    ...
    $_SESSION['message'] = "Erreur lors de la vérification : " . $e->getMessage();
    $_SESSION['message_type'] = "error";
    header('Location: mes-reservations.php');
    exit();
}

// Traitement de la confirmation d'annulation
...
<head>
    ...
    <title>Annuler la Réservation - FootBooking</title>
        ...
        <div class="confirmation-card">
            ...
            <div class="reservation-summary">
                ...
                <div class="summary-item">
                    ...
                    <span class="summary-value"><?php echo htmlspecialchars($reservation['nom_terrain']); ?></span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Ville</span>
                    <span class="summary-value"><?php echo htmlspecialchars($reservation['ville']); ?></span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Date</span>
                    <span class="summary-value"><?php echo date('d/m/Y', strtotime($reservation['date_reservation'])); ?></span>
                </div>
                <div class="summary-item">
            ...
            <div class="warning-message">
                <p>
                    ...
                    <strong>Attention:</strong> Cette action est irréversible. Une fois annulée, vous devrez créer une nouvelle réservation si vous changez d'avis.
                </p>
            </div>

            <form method="POST">
                <div class="actions">
                    <a href="mes-reservations.php" class="btn btn-cancel">
                        <i class="fas fa-arrow-left"></i>
                        Retour
                    </a>
                    <button type="submit" name="confirmer_annulation" class="btn btn-confirm">
